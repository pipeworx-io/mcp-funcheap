...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/funcheap_search_events \
  -H 'Content-Type: application/json' \
  -d '{"query":"outdoor movie","tags":"free,outdoor","after":"2026-06-19"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/funcheap_search_events`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
